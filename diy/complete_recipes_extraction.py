...
# -*- coding: utf-8 -*-
"""
完整配方提取脚本 - 一次性提取所有配方，恢复到48个并继续扩展
"""
...
def extract_all_recipes():
    ...
    print(f"开始一次性提取所有配方，总共 {len(all_recipes)} 个...")
...
if __name__ == "__main__":
    total_recipes = extract_all_recipes()
    print(f"\n🎉 配方库建设完成！总共包含 {total_recipes} 个配方")
